...
entrada_frame.pack()
entrada_texto = Text(height=10, width=50, font=('Roboto', 16))
entrada_texto.pack(padx=10, fill='both', expand='yes')

# ------- Saidas ----------
saida_frame = ttk.Frame()
...
saida_frame.pack()
saida_texto = Text(height=10, width=50, font=('Roboto', 16), state='disabled')
saida_texto.pack(padx=10, fill='both', expand='yes')

botao = ttk.Button(text='Traduzir', command=traduzir)
